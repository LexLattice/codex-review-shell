...
const CODEX_CLIENT_REQUEST_CONTRACTS = Object.freeze({
  ...
  "account/usage/read": { class: "usage_read", capabilityPath: ["usage", "canReadTokenUsage"] },
  "app/installed": { class: "app_runtime_read", capabilityPath: ["apps", "canReadInstalled"] },
  "app/read": { class: "app_metadata_read", capabilityPath: ["apps", "canReadMetadata"] },
  ...
  "environment/status": { class: "environment_read", capabilityPath: ["environment", "canReadStatus"] },
  ...
  "thread/selectAccessProfile": { class: "thread_mutation", capabilityPath: ["threads", "canSelectAccessProfile"] },
