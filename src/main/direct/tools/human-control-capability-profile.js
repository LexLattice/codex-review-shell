...
const TOOL_CONFIG = Object.freeze({
  ...
  view_image: {
    ...
    resultEnvelopeKinds: ["image_view_staging_envelope@1"],
    implementationState: "schema_only",
    promotionState: "diagnostic_only",
    decision: "blocked",
    profileStatus: "guarded_metadata_only",
    declarationPosture: "resident_visible_guarded_blocked",
    unavailableReason: "image_metadata_projection_deferred_to_pr107",
    blocker: "image_view_metadata_gate_missing",
    futurePrOwner: "PR107",
  },
  new_context: {
