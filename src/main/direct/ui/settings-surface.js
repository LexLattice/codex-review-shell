...
function buildRows(sections) {
  ...
  return {
    ...
    agentRuntime: [
      ...
      statusRow("Mailbox messages", `${agentRuntime.mailboxMessageCount} · dup ${agentRuntime.duplicateMailboxMessageCount}`, agentRuntime.duplicateMailboxMessageCount ? "blocked" : "ok"),
