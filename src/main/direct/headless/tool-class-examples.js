...
function defaultExamples() {
  return [
    ...
    },
    {
      ...
      testMode: "headless_fixture",
      realismTier: "headless_runtime",
      runnerScripts: ["scripts/direct-agent-runtime-substrate-regression.mjs", "scripts/direct-text-sub-agent-tool-surface-regression.mjs", "scripts/direct-live-sub-agent-tool-surface-regression.mjs"],
      npmScripts: ["direct:agent-runtime-substrate", "direct:text-sub-agent-tool-surface", "direct:live-sub-agent-tool-surface"],
      inputExample: {
        schema: "direct_text_sub_agent_spawn_request_example@1",
        agentClassKind: "implementation_worker",
        childToolsAllowed: false,
      },
      expectedEvidenceSchemas: ["direct_text_sub_agent_tool_surface", "direct_live_sub_agent_tool_surface", "direct_agent_wait_plan", "direct_agent_mailbox_write_plan"],
      successAssertions: ["agent graph identity is explicit", "child tool authority is not inherited", "inspect_agent is an E-channel read-only affordance"],
      forbiddenSideEffects: ["recursive_spawn_default", "parent_success_laundering", "child_tool_inheritance", "inspect_interference"],
    },
    {
