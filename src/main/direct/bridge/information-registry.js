...
const DIRECT_INFORMATION_BRIDGE_ROWS = Object.freeze([
  ...
  },
  {
    ...
    bridgeFit: "Models provider-hosted web search and image generation as metadata-backed capability rows with activation snapshots, request-shape proof, declaration policy, per-call envelopes, outbound query/prompt policies, raw exposure scans, web-search result envelopes, context-admission records, distinct external evidence and generated artifact contracts, source/result policy, and provider metadata refs.",
    realignment: "This slice enables no browser navigation, local web cache ingestion, workspace artifact write, raw prompt/query/result/page storage, durable memory, or trust promotion. Web result envelopes and context-admission records can classify sanitized source refs and summaries, but hosted execution and durable admission remain separately gated.",
  },
  {
