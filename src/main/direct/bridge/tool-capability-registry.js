  ...
  return [
    ...
    ...["web_search", "image_generation"].map((name) => ({
      ...
      requestShapeFamilies: name === "web_search"
        ? ["provider_hosted_tool_capability", "provider_hosted_request_shape_proof", "provider_hosted_tool_activation_snapshot", "provider_hosted_tool_call_envelope", "provider_hosted_web_search_query_policy", "provider_hosted_web_search_query_envelope", "provider_hosted_raw_exposure_scan", "provider_web_search_evidence_contract", "provider_hosted_result"]
      ...
      recoveryLaw: name === "web_search"
        ? "Web search result is external epistemic evidence requiring activation snapshot, request-shape proof, call envelope, outbound query scan, source refs, retrieval time, citation policy, and staleness."
