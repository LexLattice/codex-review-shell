...
function buildThreadDeckRow(entry = {}, options = {}) {
  ...
  const row = {
    ...
    agentLabel: boundedString(entry.agentLabel, 120),
    ...
    transcriptLane: normalizeString(entry.agentKind, "") ? "worker" : "primary",
    primaryTranscriptSeparated: normalizeString(entry.agentKind, "") ? true : false,
