...
const usageJs = read("src/renderer/direct-usage-surface.js");
...
assert.match(alternateHtml, /data-t3-action="usage"/);
assert.match(alternateHtml, /data-t3-action="projects"/);
...
assert.match(alternateHtml, /data-morphic-region="direct-usage-overview"/);
assert.match(alternateHtml, /src="\.\/direct-usage-surface\.js"/);
...
assert.match(projectDirectoryJs, /readDirectWorkbenchProjectDirectory/);
assert.match(projectDirectoryJs, /activateDirectWorkbenchProject/);
...
assert.match(projectDirectoryJs, /Main revalidates its substrate and runtime/);
...
assert.match(usageJs, /getDirectUsageOverview/);
assert.match(usageJs, /not billing-grade/);
assert.match(usageJs, /missing usage as unknown, not zero/);
