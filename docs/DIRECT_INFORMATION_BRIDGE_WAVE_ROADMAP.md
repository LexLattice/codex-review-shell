...
| `#142` | open | `codex/direct-constitutional-policy-pr142` | Constitutional policy and self-binding records | ConstitutionalPolicyProfile, policy rules/exceptions, SelfBindingPreferenceRecord, AdminModePolicyUpdate, policy store, deterministic policy precedence trace, casual-yes and child-broadening negative fixtures | No autonomous policy mutation, hidden admin-mode inference, or broad blocker for every unresolved safe/control-plane conflict |
